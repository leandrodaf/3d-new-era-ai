...
mod tests {
    ...
    fn a_blind_in_its_wall_and_a_shaft_outside_rooms_can_be_accepted() {
        ...
        let blind_key = report["in_wall"][0][2]
            .as_str()
