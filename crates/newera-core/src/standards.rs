...
pub static STANDARDS: &[Standard] = &[
    ...
    s(
        "nbr13103",
        "ABNT NBR 13103:2024 — Instalação de aparelhos a gás",
        "2024",
        Tier::A,
    ...
    s(
        ...
        "2020",
        Tier::A,
        "Projeto, execução e manutenção da água fria e quente: alimentação de cada aparelho, registros e materiais.",
        None,
        ConfirmBeforeUse,
    ),
    s(
        ...
        "1999",
        Tier::A,
        "Ramais de descarga por aparelho, caimento mínimo, caixas sifonadas, de gordura e de inspeção.",
        None,
        ConfirmBeforeUse,
    ),
    s(
        ...
        "2019",
        Tier::A,
        "Cabeamento de telecomunicações: tomadas de rede, cabos e o ponto de distribuição que os reúne.",
        None,
        ConfirmBeforeUse,
    ),
    s(
