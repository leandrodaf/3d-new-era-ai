...
for tool in get_home create update delete move split_wall set_home set_background render_plan export_plan save_home open_home new_home undo redo catalog place check_layout variants levels materials cameras video plugins sessions arrange trace_background joinery cut_list disciplines annotations render_3d render_photo; do
